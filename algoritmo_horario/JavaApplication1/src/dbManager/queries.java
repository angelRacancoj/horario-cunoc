...
public class queries {
    ...
    public static final String PESOS = "SELECT CC1.CURSO_id AS ID,"
            + "CASE WHEN ((CC1.semestre = CC2.semestre) AND (CC1.CARRERA_id = CC2.CARRERA_id) AND (CC1.es_obligatorio = CC2.es_obligatorio)) THEN '4' ELSE "
            ...
            + "CASE WHEN ((CC1.semestre = CC2.semestre) AND (CC1.CARRERA_id <> CC2.CARRERA_id) AND (CC1.es_obligatorio <> CC2.es_obligatorio)) THEN '2' ELSE "
            + "CASE WHEN ((CC1.semestre <> CC2.semestre) AND (CC1.CARRERA_id = CC2.CARRERA_id) AND (CC1.es_obligatorio <> CC2.es_obligatorio)) THEN '2' ELSE "
            + "CASE WHEN ((CC1.semestre <> CC2.semestre) AND (CC1.CARRERA_id <> CC2.CARRERA_id) AND (CC1.es_obligatorio <> CC2.es_obligatorio)) THEN '1' "
