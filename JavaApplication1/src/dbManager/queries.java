...
public class queries {
    ...
    public static final String SON_OBLIGATORIOS = "SELECT COUNT(*) FROM CARRERA_CURSO AS CC1 INNER JOIN CARRERA_CURSO AS CC2 ON (CC2.CURSO_id = ?) AND (CC1.CURSO_id = ?) AND (CC1.es_obligatorio = CC2.es_obligatorio) AND (CC1.es_obligatorio = ?)";
